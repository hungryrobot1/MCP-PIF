...
export interface SetActiveProjectRequest {
  project_id?: string;  // None to clear active
}
...
export function documentRecordToDocument(record: DocumentRecord): Document {
  return {
    id: record.id,
...
export function thoughtRecordToThought(record: ThoughtRecord): Thought {
  return {
    id: record.id,
